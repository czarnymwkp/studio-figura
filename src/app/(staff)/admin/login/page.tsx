...
export default function AdminLoginPage() {
  return (
    <Card className="flex flex-col gap-4 items-center w-full max-w-sm mx-auto border-2 border-orange-500/10 bg-white/5 p-4">
      ...
      <Input type="text" placeholder="Login" className="border border-white/10 p-2 rounded-md" />
      <Input type="password" placeholder="Hasło" className="border border-white/10 p-2 rounded-md" />
