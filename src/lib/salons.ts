...
export const SALONS: Salon[] = sortSalons([
  ...
  },
  {
    slug: "janow-lubelski",
    city: "Janów Lubelski",
    name: "Studio Figura Janów Lubelski",
    address: "ul. Piłsudskiego 9",
    postalCode: "23-300 Janów Lubelski",
    phone: "690 139 002",
    email: "studiofigurajanowlubelski@gmail.com",
    hours: ["pn–pt 9:00 – 20:00", "sob 9:00 – 15:00"],
    openingHoursSchema: ["Mo-Fr 09:00-20:00", "Sa 09:00-15:00"],
    lat: 50.707,
    lng: 22.411,
    mapsUrl: "https://maps.google.com/?q=Studio+Figura+Jan%C3%B3w+Lubelski+Pi%C5%82sudskiego+9",
  },
  {
    slug: "sandomierz",
    city: "Sandomierz",
